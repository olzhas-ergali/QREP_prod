...
class UnprocessableError(BaseError):
    def __init__(
        self, *_: tuple[Any], message: str = "Validation errors"
    ) -> None:
        super().__init__(
            message=message,
...
class DatabaseError(BaseError):
    def __init__(
        self, *_: tuple[Any], message: str = "Database errors"
    ) -> None:
        super().__init__(
...
class AuthenticationError(BaseError):
    def __init__(
        self, *_: tuple[Any], message: str = "Authentication errors"
    ) -> None:
        super().__init__(
            message=message,
...
class AuthorizationError(BaseError):
    def __init__(
        self, *_: tuple[Any], message: str = "Authorization errors"
    ) -> None:
        super().__init__(
