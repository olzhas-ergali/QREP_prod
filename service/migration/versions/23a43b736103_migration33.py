...
Revision ID: 23a43b736103
Revises: 9ffe7226765f
Create Date: 2025-08-21 17:23:33.231783
...
revision: str = '23a43b736103'
down_revision: Union[str, None] = '9ffe7226765f'
...
def upgrade() -> None:
    ...
    op.execute("ALTER TYPE eventtype ADD VALUE IF NOT EXISTS 'promo_message_annulled'")
