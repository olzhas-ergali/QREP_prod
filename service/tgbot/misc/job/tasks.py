...
from service.API.infrastructure.database.models import RegTemp, ClientsApp
from service.tgbot.keyboards.auth import get_continue_btn
from service.tgbot.keyboards.client.faq import get_answer
from service.API.infrastructure.database.loyalty import BonusExpirationNotifications, ClientBonusPoints
        ...
        for bonus in bonuses:
            try:
                ...
                await bot.send_message(
                    ...
                    text=texts.get((bonus.expiration_date.date() - date_now).days)
                )
